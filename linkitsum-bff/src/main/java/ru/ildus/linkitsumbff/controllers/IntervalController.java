...
@RestController
@RequestMapping("/interval") // базовый URI
public class IntervalController {
    ...
    @Autowired
    public IntervalController(ParserUtil parserUtil) { // внедряем объекты
...
//        restTemplate.setRequestFactory(new HttpComponentsClientHttpRequestFactory());
    ...
    @PostMapping("/all")
    public ResponseEntity<List<Interval>> getAllIntervals(@CookieValue(value = "AT", required = false) String acToken, @CookieValue(value = "IT", required = false) String iToken) {
...
//        System.out.println();
        ...
        ResponseEntity<List<Interval>> response = restTemplate.exchange(
                resourceServerURL + "interval/all",
                HttpMethod.POST,
                request,
                new ParameterizedTypeReference<List<Interval>>(){});
